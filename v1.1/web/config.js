...
window.APP_CONFIG = {
  SUPABASE_URL: 'https://okoejjgzpxvfqutsqfpb.supabase.co',       // e.g. 'https://abcdefgh.supabase.co'
  SUPABASE_ANON_KEY: 'sb_publishable_t38Xn10OjbTGReSRZOlOsA_M943C9gQ',  // the "anon / public" key, NOT the service key
